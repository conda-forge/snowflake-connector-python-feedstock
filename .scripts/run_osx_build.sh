...
validate_recipe_outputs "snowflake-connector-python-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="snowflake-connector-python-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi